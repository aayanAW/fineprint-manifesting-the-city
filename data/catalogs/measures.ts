import type { Measure } from '@/types/advise';
...
export const MEASURES: Measure[] = [
  {
    ...
    typicalCostNote: '~$5,000/unit prescriptive (Con Ed Clean Heat / MFEEP-E rebate basis) up to ~$15k-30k+/unit installed for whole-building conversion before incentive/IRA stacking; highly building-specific (steam-to-hydronic vs packaged window/PTHP heat pumps vary widely)',
  ...
  },
  {
    ...
    typicalCostNote: 'Central/commercial HPWH systems typically several thousand $ per dwelling unit installed; NYC Accelerator notes incentives reduce project costs ~40-70%',
  ...
  },
  {
    ...
    typicalCostNote: 'Steam distribution + controls upgrades cost less than ~$1/sf; ~$75,000-$100,000 for a medium-size multifamily building (Urban Green Council); Heat-Timer-style boiler controls (outdoor reset, wireless sensors) report 15-50% heating savings (treat vendor upper end cautiously)',
  ...
  },
  {
    ...
    emissionsReductionPctHigh: 25,
    typicalCostPerUnitUSDMax: null,
    typicalCostNote: 'NYSERDA Seal-and-Insulate / Comfort Home packages carry $2,000-$3,000+ rebates per package (attics higher); full window replacement is far costlier and project-specific. EPA: 11-15% total energy savings from sealing/insulating; NYC Climate Zone 4A can reach 17-25% bill savings',
  ...
  },
  {
    ...
    typicalCostPerUnitUSDMax: null,
    typicalCostNote: 'Con Ed MFEEP/AMEEP pays per-unit rates ($5/sf attic insulation, $3-$5/therm air sealing); NYSERDA Comfort Home / Seal-and-Insulate packages $2,000-$3,000+ rebate per package',
  ...
  },
  {
    ...
    typicalCostPerUnitUSDMax: null,
    typicalCostNote: 'Low-cost, fast-ROI: ~$1-3/sf for common-area LED + occupancy/daylight controls (industry-typical estimate, not a single cited NYC figure); often largely covered by Con Ed / NYSERDA prescriptive lighting incentives (LED $5-$8/lamp, fixtures $45-$150, sensors $10)',
    url: 'https://www.urbangreencouncil.org/ll97-in-focus-jumpstarting-multifamily-building-upgrades/',
  },
  {
    key: 'solar-pv',
    ...
    typicalCostPerUnitUSDMax: null,
    typicalCostNote: '~$2.65-$4.30/W installed pre-incentive for multifamily/small-commercial (NYSERDA NY-Sun). NY-Sun Megawatt Block + a Multifamily Affordable Housing Incentive (~$1.60-$2.00/W) plus the §48E ITC substantially lower net cost',
